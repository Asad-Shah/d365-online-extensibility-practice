...
import { IMySearchResultContainerData } from './my-search-result-container.data';
import { IMySearchResultContainerProps } from './my-search-result-container.props.autogenerated';

export interface ISearchResultContainerViewProps extends IMySearchResultContainerProps<{}> {
 ...
 * @extends {React.PureComponent<IMySearchResultContainerProps<IMySearchResultContainerData>>}
 */
@observer
export default class SearchResultContainer extends React.PureComponent<IMySearchResultContainerProps<IMySearchResultContainerData>, ISearchResultContainerState> {
    ...
    constructor(props: IMySearchResultContainerProps<IMySearchResultContainerData>, state: ISearchResultContainerState) {
        super(props);
    ...
    public render(): JSX.Element {
        const { imageSettings, className, parentText } = this.props.config;
